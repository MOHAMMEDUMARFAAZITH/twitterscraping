...
with col1:
   if st.button("SHOW DATA AS A PANDAS DATAFRAME"):    
      st.write(df)
...
with col4:
   ...
   d = st.download_button("DOWNLOAD DATA AS CSV FORMAT",json_string,"file.json","application/json",key='download-json')
if d:
